...
for no_of_layers in layers:
	for no_of_channels in channels:
		for activation in activations:
			...
			model_checkpoint_file = "100k_fit_and_evaluate_experiments_kipf/kipf_model_%d_%d_%s.ckpt" % (no_of_layers, no_of_channels, activation_name)
			...
			job_file_name = "100k_fit_and_evaluate_experiments_kipf/kipf_%d.job" % i
