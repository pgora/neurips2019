...
working_path = "100k_fit_and_evaluate_experiments_kipf/"
...
result_file_name = "100k_fit_and_evaluate_experiments_kipf/fit_eval_results_kipf.csv"
...
if __name__ == '__main__':
	...
	while(True):
		...
		if len(jobs) > 0:
			...
			simulation_test_Xy_filename = "100k_fit_and_evaluate_experiments_kipf/simulation_Xy_%d_%d_%s_kipf.csv" % (no_of_layers, no_of_channels, activation_name)
